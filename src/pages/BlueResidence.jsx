                            ...
                            <div className='Container_white_bg_hp my-4'>
                                <div className='Property_Detail_contact_section'>
                                    ...
                                    <div data-aos="zoom-in-up">
                                        <h4 className='mb-3 mt-5'>Blue Residence Club - Property For Sale</h4>
                                        <p>
                                            For centuries Aruba has enticed explorers to its pristine shores with the allure of endless beauty and natural wonders. And for more than 60 years Pering Group, developers of Oceania, have provided its clients with excellent real estate solutions. Blue Residence Club represents the finest apartment for the condo-oriented family. Blue Residence Club will consist in its entirety of 127 luxury condos. The First Phase of this development has 42 condos, of which more than half of the units are already sold to date! Construction has already started since late 2011 and the First Phase will be completed (ready for occupancy) in the fall of 2014.If you are already in the process of deciding to buy in Aruba, please inquire via our contact form on this website and we will send you a free information package via e-mail or regular mail.
                                        </p>
                                    </div>
                                </div>
                            </div >
                            ...
                            <div className='Property_Detail_images_list_area'>
                                <div className='Property_Detail_images_item position-relative' data-aos="zoom-in-up">
                                    ...
                                    <div className='Property_Detail_images_content'>
                                        <h4>Location</h4>
                                        <p>
                                            The Blue Residence Club is located in front of a picturesque and unique bay just at the southernmost edge of the world-famous Palm Beach strip and of the high-rise hotel area of the island. As part of the development plans of Blue Residence Club, this picturesque beach will also be enlarged, enhanced and upgraded commensurate to the high standards of this luxury resort, thereby adding several guests facilities, palapas and lounging furniture. This location is thus only a few minutes walk from the many high-rolling casinos, exquisite restaurants, various shopping facilties and of course the booming nightlife entertainment centers of Palm Beach. Yet, by being just outside the high-activity section of the Palm Beach, with it's semi-private and secluded beach, the Blue Residence Club is the ideal place to savor your well-deserved time of relaxation and tranquility away from the modern hassles. Another major advantage of this location is its simultaneous and comparable 'stone-throw' promixity to the Eagle Beach (the other major beach attraction of Aruba) where you will also find the customary wide and white-sandy beach, turquoise water and uniquely uncrowded calmness....
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='Property_Detail_images_item position-relative' data-aos="zoom-in-up">
                                    ...
                                    <div className='Property_Detail_images_content'>
                                        <h4>Luxury condos at its best</h4>
                                        <p>
                                            Undoubtedly, Blue Residence Club offers THE premiere condo residence with combined amenities and service that is second to none on the island of Aruba. Choose from 2-bedroom units to the largest whopping 5-bedroom penthouses, all with unprecendented panoramic ocean views! Indicative standards are set for the furnishing and equipment of each unit to the option of its owner, in order to maintain the desired quality level of this luxury residential resort.
                                        </p>
                                    </div>
                                </div>
